...
public abstract class ElasticsearchUpsertTableSinkBase implements UpsertStreamTableSink<Row> {
    ...
    /**
     * Map of optional configuration parameters for the Elasticsearch sink. The config is internal
    ...
    public interface RequestFactory extends Serializable {
        ...
        /**
         * Creates an update request to be added to a {@link RequestIndexer}. Note: the type field
         * has been deprecated since Elasticsearch 7.x and it would not take any effort.
         */
        ...
        /**
         * Creates an index request to be added to a {@link RequestIndexer}. Note: the type field
         * has been deprecated since Elasticsearch 7.x and it would not take any effort.
         */
        ...
        /**
         * Creates a delete request to be added to a {@link RequestIndexer}. Note: the type field
         * has been deprecated since Elasticsearch 7.x and it would not take any effort.
         */
    ...
    public static class ElasticsearchUpsertSinkFunction
            ...
            if (keyFieldIndices.length == 0) {
                final IndexRequest indexRequest =
                        requestFactory.createIndexRequest(
                                formattedIndex, docType, contentType, document);
                indexer.add(indexRequest);
            } else {
                final String key = createKey(row);
                final UpdateRequest updateRequest =
                        requestFactory.createUpdateRequest(
                                formattedIndex, docType, key, contentType, document);
        ...
        private void processDelete(Row row, RequestIndexer indexer, String formattedIndex) {
            ...
            final DeleteRequest deleteRequest =
                    requestFactory.createDeleteRequest(formattedIndex, docType, key);
