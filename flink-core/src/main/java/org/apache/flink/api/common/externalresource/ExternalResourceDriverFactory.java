...
public interface ExternalResourceDriverFactory {
    /**
     * Construct the ExternalResourceDriver from configuration and total amount.
     *
     ...
     */
    ExternalResourceDriver createExternalResourceDriver(ExternalResourceDriverConfiguration config)
            throws Exception;
}
