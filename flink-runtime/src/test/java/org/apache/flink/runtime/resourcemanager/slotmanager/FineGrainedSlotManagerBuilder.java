...
public class FineGrainedSlotManagerBuilder {
    private TaskExecutorMatchingStrategy taskExecutorMatchingStrategy;
    private TaskExecutorAllocationStrategy taskExecutorAllocationStrategy;
    ...
    private TaskExecutorTracker taskExecutorTracker;
    private Executor executor;

    private FineGrainedSlotManagerBuilder() {
        this.taskExecutorMatchingStrategy = AnyMatchingTaskExecutorMatchingStrategy.INSTANCE;
        ...
        this.taskExecutorTracker = new FineGrainedTaskExecutorTracker();
    ...
    public FineGrainedSlotManagerBuilder setTaskExecutorTracker(
            TaskExecutorTracker taskExecutorTracker) {
        this.taskExecutorTracker = taskExecutorTracker;
        return this;
    }
    ...
    public FineGrainedSlotManagerBuilder setTaskExecutorMatchingStrategy(
            TaskExecutorMatchingStrategy taskExecutorMatchingStrategy) {
        this.taskExecutorMatchingStrategy = taskExecutorMatchingStrategy;
        return this;
    }

    public FineGrainedSlotManagerBuilder setTaskExecutorAllocationStrategy(
            TaskExecutorAllocationStrategy taskExecutorAllocationStrategy) {
        this.taskExecutorAllocationStrategy = taskExecutorAllocationStrategy;
        return this;
    }
    ...
    public FineGrainedSlotManager build() {
        final SlotManagerConfiguration slotManagerConfiguration =
                new SlotManagerConfiguration(
                        ...
                        taskExecutorAllocationStrategy == null
